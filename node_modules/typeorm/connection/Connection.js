...
var Connection = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        if (!(this.options.dropSchema || this.options.dropSchemaOnConnection)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.dropDatabase()];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5:
                        if (!(this.options.synchronize || this.options.autoSchemaSync)) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.synchronize()];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7:
                        if (!(this.options.migrationsRun || this.options.autoMigrationsRun)) return [3 /*break*/, 9];
    ...
    Connection.prototype.createQueryRunner = function () {
        var queryRunner = this.driver.createQueryRunner();
