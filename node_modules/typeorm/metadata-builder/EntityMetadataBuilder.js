    ...
    EntityMetadataBuilder.prototype.build = function (entityClasses) {
        ...
        entityMetadatas.forEach(function (entityMetadata) {
            entityMetadata.columns.forEach(function (column) {
                var generated = _this.metadataArgsStorage.findGenerated(entityMetadata.target, column.propertyName);
                if (generated) {
            ...
            entityMetadata.generatedColumns = entityMetadata.columns.filter(function (column) { return column.isGenerated; });
        });
